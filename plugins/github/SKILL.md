...
```bash
./plugins/github/scripts/pr-create.sh <タイトル> <本文>
```
...
```bash
./plugins/github/scripts/pr-number.sh
```
...
```bash
./plugins/github/scripts/pr-checks.sh <PR番号>
```
...
```bash
./plugins/github/scripts/thread-list.sh <PR番号>
```
...
```bash
./plugins/github/scripts/thread-details.sh <スレッドID> [スレッドID...]
```
...
```bash
./plugins/github/scripts/thread-reply.sh <スレッドID> "コメント内容"
```
...
```bash
./plugins/github/scripts/thread-resolve.sh <スレッドID>
```
...
```bash
./plugins/github/scripts/workflow-log.sh <run-id>
```
